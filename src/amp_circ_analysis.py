...
def main():
    ...
    valid = (x > 0) & (y > 0) & (x <= 0.15)   # fit only ε = 0 to 0.15
    ...
    plt.tight_layout()
    out_path = OUTPUT_DIR / 'amp_circ_loglog_response_eps0_015.png'
    ...
    plt.tight_layout()
    out_path2 = OUTPUT_DIR / 'amp_circ_linear_response_eps0_015.png'
